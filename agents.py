...
def create_agents() -> tuple[Agent, Agent, Agent]:
    """Factory — tạo agents với key mới mỗi lần gọi (key rotation).
    Gọi trước mỗi cycle để đảm bảo key xoay vòng khi một key bị 429.
    """
    ...
    return quant_strategist, algo_dev, risk_auditor